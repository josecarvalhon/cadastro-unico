...
def buscar_clientes(
    q: str | None = Query(None, description="Texto buscado em nome (ILIKE)"),
    doc: str | None = Query(None, description="CPF ou CNPJ; pontuação opcional"),
...
def detalhar_cliente(id_golden: str) -> EntidadeDetalhe:
    result = detalhar("golden_clientes", id_golden)
    if result is None:
